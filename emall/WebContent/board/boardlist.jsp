...
<body>
	...
	<div class="container">
		<div class="row" align="center">
			...
			<%		//for 문 (시작)
			ArrayList<BoardDTO> products = (new BoardDAO()).getList();
			
			
				for (ProductDTO board : boards){
			...
			<div class="col-md-4">
				...
				<!-- 칸에 꽉 채워라 -->
				<h3><%=board.getPname() %></h3>
				<p><%=board.getPprice() %>원
				<p><a href="productdetail.jsp?pid=<%=board.getPid() %>" class="btn btn-secondary" role="button">상세정보</a>
