...
<div class="container" >
  ...
  <div class="row g-5">
    ...
    <div class="col-md-7 col-lg-8">
      ...
      <form action="reviewadddb.jsp" method="post" class="needs-validation" novalidate>
        <div class="row g-3">
            <hr class="my-4">
            ...
            <textarea name="content" class="form-control" id="review" rows="10" cols="50"></textarea>
        ...
        <button type="submit" class="w-100 btn btn-primary btn-lg" type="submit">작성 완료</button>
